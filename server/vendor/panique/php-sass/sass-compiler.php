...
class SassCompiler
{
     ...
     */
    static public function run($scss_folder, $css_folder, $scss_base = "*.scss", $format_style = "scss_formatter")
    {
        ...
        // get .scss files from scss folder
        $filelist = glob($scss_folder . $scss_base);
